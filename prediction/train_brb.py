...
bslc_hhid = bslc_hhid[['hhid', 'weight', 'psu']]
bslc_income = bslc_income[['hhid', 'id', 'q10_02a', 'q10_04a', 'q10_06', 'q10_07', 'q10_08', 'q10_09', 'q10_10', 'q10_11', 'q10_12', 'q10_13', 'q10_14', 'q10_15',
...
bslc_hh = bslc_hhincome.merge(bslc_hhid, left_on = 'hhid', right_on = 'hhid')
...
lca_dist_feat = pd.read_csv(os.path.join(c.features_dir, 'aggregate_mosaiks_features_lca_dist.csv'), index_col = 0)
...
## keep variables of interest
lfs_2016 = lfs_2016[['district', 'wt', 'income']]
lca_2010 = lca_2010[['district', 'ed', 'hh', 'p34_per_num', 'hhincome', 'settlement']]
