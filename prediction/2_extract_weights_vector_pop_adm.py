...
pop = pd.read_csv(os.path.join(c.data_dir, 'int', 'applications', 'population', 'population_density_global.csv'), index_col = 0)
subnat_pop = pd.read_csv(os.path.join(c.data_dir, 'int', 'applications', 'population', 'population_density_global_subnat.csv'), index_col = 0)
